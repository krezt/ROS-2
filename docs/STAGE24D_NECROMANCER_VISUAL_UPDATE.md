# Stage 24D Necromancer Visual Update

This update applies the Archer production method to the Necromancer as a visual-only asset refresh.
...
- `docs/concepts/stage24d-necromancer-approved-sprite-source.png`
- `docs/concepts/stage24d-necromancer-approved-vfx-source.png`
...
- validation contact sheets `necro_runtime_*.png`
