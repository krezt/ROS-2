...
const classes = {
 ...
 Rogue:{baseStats:{maxHP:1700,QKN:30},identity:'High-pressure precision melee attacker; crits, poison imbues, marks and evasive disruption.',combat:{movementMax:16,attacksMax:9,attackInterval:1},weapon:{weaponProfileId:'ROGUE_BLADE',mode:'MELEE',weaponRange:1,preferredRange:1,counterMoveMax:1,attackBaseMin:55,attackBaseMax:100,critBonus:.10},abilities:[
  ...
  ab('POISON_DAGGER','Poison Imbue','normal',A.SPELL,T.SELF,[status('poison_imbue',4,{to:'SELF',data:{damageRatio:.65}})],{note:'For 4 rounds, every successful basic hit adds Poison while the imbue remains active.'}),
 ...
 Archer:{baseStats:{maxHP:1700,QKN:14},identity:'Long-range physical pressure; precision, marks, ranged control and area barrages.',combat:{movementMax:12,attacksMax:7,attackInterval:2},weapon:{weaponProfileId:'LONGBOW',mode:'RANGED',weaponRange:6,preferredRange:6,counterMoveMax:3,attackBaseMin:69,attackBaseMax:106,critBonus:.08},abilities:[
  ...
  ab('SNIPE','Snipe',0,A.BASIC_ATTACK,T.UNIT,[],{basicStyle:{attacksSet:3,damageMultiplier:2.25,attackRangeOverride:9,ordinaryKite:true,distanceDamageBonusPerSquare:.05},note:'Three long-range kiting shots at 225% base damage, plus 5% more damage per square of actual separation when each shot is fired. Range 9.'}),
 ...
 Electromancer:{baseStats:{maxHP:1614,QKN:15},identity:'Aggressive magical hybrid; electricity, stun, chain damage, self-reset, evasion and team offense.',combat:{movementMax:12,attacksMax:7,attackInterval:1},weapon:{weaponProfileId:'SHOCK_GAUNTLET',mode:'MELEE',weaponRange:2,preferredRange:2,counterMoveMax:1,attackBaseMin:18,attackBaseMax:28},abilities:[
  ab('ELECTRO_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'DAMAGE',roundChance:.80,referenceSwings:7,maxPerRound:3,min:50,max:175,scalesWith:'SDM',damageType:D.MAGICAL,defensePenetration:.10,label:'Lightning Bolt'}}),
