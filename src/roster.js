...
const classes = {
 Warrior:{baseStats:{maxHP:2450,QKN:17},identity:'Durable frontline melee fighter; protection, taunt, sustain and strong single-target pressure.',combat:{movementMax:14,attacksMax:7,attackInterval:2},weapon:{weaponProfileId:'SWORD_SHIELD',mode:'MELEE',weaponRange:2,preferredRange:2,counterMoveMax:1,attackBaseMin:80,attackBaseMax:120},abilities:[
  ...
  ab('SHIELDWALL','Shieldwall','fast',A.ABILITY,T.ALL_ALLIES,[status('physical_shield',1,{to:'ALL_ALLIES',data:{pct:.10}}),status('shield_redirect',1,{to:'SELF',data:{remaining:5,meleeOnly:true}})]),
 ...
 Barbarian:{baseStats:{maxHP:2250,QKN:16},identity:'Aggressive heavy melee bruiser; reach, burst, defense break, stun and relentless pursuit.',combat:{movementMax:15,attacksMax:7,attackInterval:2},weapon:{weaponProfileId:'LONG_AXE',mode:'MELEE',weaponRange:3,preferredRange:3,counterMoveMax:1,attackBaseMin:80,attackBaseMax:110},abilities:[
  ...
  ab('WAR_CRY','War Cry','normal',A.SPELL,T.ALL_ENEMIES,[dmg(75,100,{damageType:D.MAGICAL,scalesWith:'ATK',dodgeable:false,to:'ALL_ENEMIES'}),status('def_down',4,{to:'ALL_ENEMIES'})],{migrationStatus:ROSTER_MIGRATION_STATUS.PROVISIONAL,spatialPolicy:'LEGACY_GLOBAL_PENDING_REVIEW'}),
 ...
 Archer:{baseStats:{maxHP:1800,QKN:14},identity:'Long-range physical pressure; precision, marks, ranged control and area barrages.',combat:{movementMax:12,attacksMax:6,attackInterval:2},weapon:{weaponProfileId:'LONGBOW',mode:'RANGED',weaponRange:6,preferredRange:6,counterMoveMax:3,attackBaseMin:80,attackBaseMax:150,critBonus:.075},abilities:[
  ...
  ab('SNIPE','Snipe',0,A.BASIC_ATTACK,T.UNIT,[],{basicStyle:{attacksSet:3,damageMultiplier:2.25,attackRangeOverride:8,ordinaryKite:true,distanceDamageBonusPerSquare:.05},note:'Three long-range kiting shots at 225% base damage, plus 5% more damage per square of actual separation when each shot is fired. Range 8.'}),
