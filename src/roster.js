...
const classes = {
 ...
 Rogue:{baseStats:{maxHP:1700,QKN:30},identity:'High-pressure precision melee attacker; crits, poison imbues, marks and evasive disruption.',combat:{movementMax:17,attacksMax:9,attackInterval:1},weapon:{weaponProfileId:'ROGUE_BLADE',mode:'MELEE',weaponRange:1,preferredRange:1,counterMoveMax:1,attackBaseMin:55,attackBaseMax:100,critBonus:.10},abilities:[
  ...
  ab('POISON_DAGGER','Poison Imbue','normal',A.SPELL,T.SELF,[status('poison_imbue',4,{to:'SELF',data:{damageRatio:.75}})],{note:"For 4 rounds, every successful basic hit adds Poison equal to 75% of that hit's damage while the imbue remains active."}),
 ...
 Cleric:{baseStats:{maxHP:1784,QKN:15},identity:'Primary restorative and defensive support with healing, poison cleansing, protection and resurrection.',combat:{movementMax:11,attacksMax:6,attackInterval:2},weapon:{weaponProfileId:'CLERIC_MACE',mode:'MELEE',weaponRange:2,preferredRange:2,counterMoveMax:1,attackBaseMin:35,attackBaseMax:60},abilities:[
  ab('CLERIC_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'HEAL_SELF',chance:.15,maxPerRound:3,min:100,max:250,scalesWith:'SDM',label:'Prayer Mend'}}),
 ...
 Mage:{baseStats:{maxHP:1700,QKN:14},identity:'High-impact ranged magical damage and team magical protection; AoE, amplification and spell duplication.',combat:{movementMax:13,attacksMax:6,attackInterval:2},weapon:{weaponProfileId:'MAGE_DAGGER',mode:'MELEE',weaponRange:3,preferredRange:3,counterMoveMax:1,attackBaseMin:25,attackBaseMax:45},abilities:[
  ab('MAGE_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'STATUS',key:'stun',chance:.06,maxPerRound:3,duration:2,label:'Arc Shock'}}),
 ...
 Paladin:{baseStats:{maxHP:1827,QKN:12},identity:'Defensive melee/support hybrid; protection, cleanse, stun and holy payoff damage.',combat:{movementMax:14,attacksMax:6,attackInterval:2},weapon:{weaponProfileId:'PALADIN_SWORD',mode:'MELEE',weaponRange:2,preferredRange:2,counterMoveMax:1,attackBaseMin:70,attackBaseMax:105},abilities:[
  ab('PALADIN_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'STATUS_SELF',chance:.25,maxPerRound:3,key:'def_up',duration:2,label:'Resolve'}}),
 ...
 Archer:{baseStats:{maxHP:1700,QKN:14},identity:'Long-range physical pressure; precision, marks, ranged control and area barrages.',combat:{movementMax:12,attacksMax:7,attackInterval:2},weapon:{weaponProfileId:'LONGBOW',mode:'RANGED',weaponRange:6,preferredRange:6,counterMoveMax:3,attackBaseMin:69,attackBaseMax:106,critBonus:.08},abilities:[
  ...
  ab('SNIPE','Snipe',0,A.BASIC_ATTACK,T.UNIT,[],{basicStyle:{attacksSet:3,damageMultiplier:2.025,attackRangeOverride:7,ordinaryKite:true,distanceDamageBonusPerSquare:.05},note:'Three long-range kiting shots at 202.5% base damage, plus 5% more damage per square of actual separation when each shot is fired. Range 7.'}),
 ...
 Monk:{baseStats:{maxHP:1614,QKN:26},identity:'Fast melee combatant; explosive attack-volume styles, stun pressure, reactive defense and self-recovery.',combat:{movementMax:15,attacksMax:7,attackInterval:1},weapon:{weaponProfileId:'MONK_FISTS',mode:'MELEE',weaponRange:1,preferredRange:1,counterMoveMax:1,attackBaseMin:55,attackBaseMax:65,critBonus:.10},abilities:[
  ab('MONK_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'STATUS_SELF',chance:.20,maxPerRound:3,key:'atk_up',duration:2,label:'Opening'}}),
 ...
 Necromancer:{baseStats:{maxHP:1700,QKN:14},identity:'Attrition caster centered on poison buildup, life stealing, percentage damage and detonation.',combat:{movementMax:11,attacksMax:5,attackInterval:2},weapon:{weaponProfileId:'NECRO_DAGGER',mode:'MELEE',weaponRange:3,preferredRange:3,counterMoveMax:1,attackBaseMin:15,attackBaseMax:30},abilities:[
  ab('NECRO_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'LIFE_DRAIN',chance:.15,maxPerRound:3,min:75,max:200,scalesWith:'SDM',damageType:D.MAGICAL,label:'Life Drip'}}),
 ...
 Mystic:{baseStats:{maxHP:1571,QKN:27},identity:'Control/disruption specialist with stun, berserk, defense collapse, scheduler manipulation and throwing-dagger backup.',combat:{movementMax:13,attacksMax:10,attackInterval:1},weapon:{weaponProfileId:'THROWING_DAGGER',mode:'RANGED',weaponRange:999,preferredRange:999,counterMoveMax:2,attackBaseMin:35,attackBaseMax:55,behavior:WEAPON_BEHAVIOR.THROWING_DAGGER,retargetPolicy:RETARGET_POLICY.IN_RANGE_RANDOM},abilities:[
  ab('MYSTIC_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'STATUS',chance:.15,maxPerRound:3,key:'def_down',duration:2,label:'Guard Falter'}}),
 ...
 Electromancer:{baseStats:{maxHP:1614,QKN:15},identity:'Aggressive magical hybrid; electricity, stun, chain damage, self-reset, evasion and team offense.',combat:{movementMax:12,attacksMax:7,attackInterval:1},weapon:{weaponProfileId:'SHOCK_GAUNTLET',mode:'MELEE',weaponRange:2,preferredRange:2,counterMoveMax:1,attackBaseMin:18,attackBaseMax:28},abilities:[
  ab('ELECTRO_ATTACK','Attack',0,A.BASIC_ATTACK,T.UNIT,[],{basicProc:{type:'DAMAGE',chance:.30,maxPerRound:3,min:50,max:175,scalesWith:'SDM',damageType:D.MAGICAL,defensePenetration:.10,label:'Lightning Bolt'}}),
